...
CREATE TABLE `konsultasi` (
  ...
  KEY `riwayat_konsultasi_id` (`riwayat_id`),
  CONSTRAINT `riwayat_konsultasi_id` FOREIGN KEY (`riwayat_id`) REFERENCES `riwayat_konsultasi` (`id_riwayat`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `konsultasi` */

insert  into `konsultasi`(`id_konsultasi`,`riwayat_id`,`gangguan_id`,`nilai_gangguan`) values (3,1,'4',90),(4,2,'5',89);
...
insert  into `kontak_psikolog`(`id_kontak`,`nama`,`no_telp`,`tempat_praktik`,`jam_praktik`,`created_at`,`updated_at`) values (1,'viko','234242','banyuwangi selatan','09:00 - 16:00',NULL,'2019-05-27 01:32:58'),(2,'angga','222','gambiran','08:00 - 17:00',NULL,NULL);
...
insert  into `menu`(`id`,`name`,`link`,`icon`,`is_active`,`is_parent`,`order`) values (1,'Beranda','beranda','fa fa-list-alt',1,0,1),(2,'menu management','menu','fa fa-list-alt',0,0,2),(3,'Data Gejala','master_gejala','fa fa-list-alt',1,0,1),(4,'Data Kontak Psikolog','master_kontak_psikolog','fa fa-list-alt',1,0,5),(5,'Data Riwayat Konsultasi','master_riwayat','fa fa-list-alt',1,0,4),(6,'Ubah Password','ubah_Password','fa fa-list-alt',1,0,8),(7,'Data Gangguan','master_gangguan','fa fa-list-alt',1,0,2),(8,'Data User','master_user','fa fa-list-alt',1,0,6),(9,'Data Rule','master_rule','fa fa-list-alt',1,0,3),(10,'Data Tentang','master_tentang','fa fa-list-alt',1,0,7),(13,'Beranda','beranda','',1,0,1),(14,'Konsultasi','konsultasi','',1,0,2),(15,'Riwayat Konsultasi','riwayat','',1,0,3),(16,'Tentang','tentang','',1,0,4),(17,'Kontak','kontak','',1,0,5),(18,'ADHD Panduan','panduan','',1,16,6);
...
insert  into `riwayat_konsultasi`(`id_riwayat`,`user_id`,`keterangan`,`tanggal`) values (1,1,'konsul','2019-05-05 23:14:57'),(2,2,'konsultasi','2019-05-05 23:15:09');
...
insert  into `rule`(`id`,`id_rule`,`gejala_id`,`gangguan_id`,`nilai_cf`,`created_at`,`updated_at`) values (1,'AA01',1,4,0,'2019-04-14 02:38:49','2019-04-13 19:39:17'),(6,'AA02',30,5,12,'2019-05-27 04:04:11','2019-05-27 00:57:22'),(5,'AA03',8,4,7,'2019-04-14 06:29:59','2019-04-13 23:47:43'),(3,'AA04',1,5,10,'2019-04-14 05:42:13','2019-04-13 22:54:40'),(4,'AA05',3,5,10,'2019-04-14 05:54:19','2019-04-13 22:54:52'),(8,'AA06',27,5,2,'2019-05-27 08:20:26','2019-05-27 01:20:40');
...
insert  into `user`(`id_user`,`nama`,`jenis_kelamin`,`umur`,`alamat`,`nama_orangtua`) values (1,'Saiful','L',27,'banyuwangi','Sarjiwo'),(2,'Sarman','L',40,'jember','Bagus');
